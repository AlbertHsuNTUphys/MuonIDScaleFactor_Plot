    ...
    for process,desc in samples:
      ...
      for f in dirs:
        ...
        if (not desc[1] and process in f) or (desc[1] and process == fname):
          f_woSF = ROOT.TFile.Open("flatten/era" + era + '/NotApplyChargeFlipsf_Nominal/' + f)
          f_SF   = ROOT.TFile.Open("flatten/era" + era + '/ApplyChargeFlipsf_Nominal/' + f)
          f_p1   = ROOT.TFile.Open("flatten/era" + era + '/ApplyChargeFlipsf_UP/' + f)
          f_m1   = ROOT.TFile.Open("flatten/era" + era + '/ApplyChargeFlipsf_DOWN/' +f)
