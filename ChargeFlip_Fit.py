...
def fit(era, h_sig_OS, h_sig_SS, h_back_OS, h_back_SS, h_data_OS, h_data_SS, pt_region, eta_region,useLikelihood):
  ...
  Number['MC_os'] = sig_OS
  Number['MC_ss'] = sig_SS
  Number['data_os'] = data_OS - back_OS
  Number['data_ss'] = data_SS - back_SS
